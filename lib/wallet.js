...
// Fahrenheit is the default: this is a US-facing submission and most visitors
// will expect °F. Any explicit choice is remembered and wins from then on.
export const getUnit = () =>
  (typeof window === 'undefined' ? 'F' : localStorage.getItem(UNIT) || 'F');
